...
public class BagOfPrimitivesDeserializationBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    ...
    benchmark.timeBagOfPrimitivesDefault(1000000);
    benchmark.timeBagOfPrimitivesStreaming(1000000);
    benchmark.timeBagOfPrimitivesReflectionStreaming(1000000);

    long end = System.currentTimeMillis();
    System.out.println("time: " + (end - start));
  }

  public void main(int reps) throws Exception {
    timeBagOfPrimitivesDefault(reps);
    timeBagOfPrimitivesStreaming(reps);
    timeBagOfPrimitivesReflectionStreaming(reps);
  }
