...
public class CollectionsDeserializationBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    ...
    benchmark.timeCollectionsDefault(100000);
    benchmark.timeCollectionsStreaming(100000);
    benchmark.timeCollectionsReflectionStreaming(100000);
  ...
  public void main(int reps) throws Exception {
    timeCollectionsDefault(reps);
    timeCollectionsStreaming(reps);
    timeCollectionsReflectionStreaming(reps);
  }
